...
::: column-margin
![For temporal context, the movie *Who framed roger rabbit?* was also published in 1988](wfrr.jpg)
:::
...
::: column-margin
[![Clickbait titles in academia are on the rise, but this is not necessarily correlated with an increase of citations](clickbait.PNG){alt="For temporal context, Who framed roger rabbit? was also published in 1988"}](https://link.springer.com/chapter/10.1007/978-3-031-48044-7_32)
:::
...
PLOS Computational Biology APC is currently at \$2926, meaning each rule comes at a cost of \$296, and the entire series must have brought some serious money to the journal (APC changes overtime, but I´m estimating \>\$600k - assuming the series is treated as regular submissions.)
...
[Stephen Heard](https://x.com/StephenBHeard) had already commented on this trend on his [blog](https://scientistseessquirrel.wordpress.com/2023/10/31/10-simple-rules-for-writing-10-simple-rules-papers/) less than a year ago. Along with a quality parody of this trending genre of papers, his blog ends up highlighs the epitome article of the *Ten simple rules*... series: [Ten Simple Rules for Writing a PLOS Ten Simple Rules Article](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003858). Published back in 2014, the article is still a fun read with some interesting data on the series. Back then Philip E. Bourne was present in almost half of the papers on the series.
