...
![](plot3.png){fig-alt="A graph with the number of citations accumulated per year against year published of papers with 10 simple rules in its title"}
